...
function Sidebar() {
  return (
    <aside className="sidebar">
      <div className="brand"><span>⌂</span> Home</div>

      <nav className="nav">
        <a className="nav-item active" href="#"><span>✓</span> My Tasks</a>
        <a className="nav-item" href="#"><span>▱</span> Projects</a>
        <a className="nav-item" href="#"><span>◔</span> Analytics</a>
        <a className="nav-item" href="#"><span>⚙</span> Settings</a>
      </nav>
